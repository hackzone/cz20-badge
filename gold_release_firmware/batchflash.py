...
def flash_daemon(number):
    ...
    while True:
        ...
        if device is not None:
            ...
            sys.stdout.flush()
            system('env CONFIG_ESPTOOLPY_PORT_X=%s esptool.py --baud 250000 write_flash 0x1e1000 initial_fs.zip 0xd000 ota_data_initial.bin 0x1000 bootloader.bin 0x10000 firmware.bin 0x8000 generic_4MB.bin' % device)
